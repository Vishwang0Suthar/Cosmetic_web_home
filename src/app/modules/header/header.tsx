...
import {CartIcon, SearchIcon, AccountIcon } from "../assets/Icons/icons";
...
const Header = ({CartIcon}: Props) => {
  return (
    <div className='fixed top-0 z-10 flex flex-row p-4 pr-8  w-full ' >
        <div className='flex flex-grow-[1] gap-24  '>
<a href='#'> <Image
      src={logo}
      alt="logo"
        width={70}
